    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            if (readLine.equals("user")) {
                person.add(new Person.User());
            } else if (readLine.equals("looser")) {
                person.add(new Person.Looser());
            } else if (readLine.equals("coder")) {
                person.add(new Person.Coder());
            } else if (readLine.equals("proger")) {
                person.add(new Person.Proger());
            } else break;
        }
        for (Person element : person) {
            doWork(element); //вызываем doWork
        }
    }
